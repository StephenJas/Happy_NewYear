...
$(document).ready(function(){   
    ...
    var mess = "<span>哈喽，H3的同学们！！！</span><span class='B-span2'>祝你，元旦快乐！</span><span>Hello, 2022, happy new year</span><span>2022，志在必得！！！</span><span>中考必胜！</span><span>zzl贼可爱呢！</span><span>芜湖！起飞！</span>";
    $(".Barrage").append(mess);
    ...
    $(".buts").click(function(){
        ...
        if(!mes){
          // alert("你还没输入内容呢!")
          var Tipss = "<div class='Tipss'>同学，您还没输入内容呢</div>";
          $("body").append(Tipss);
          setTimeout(function(){
            $(".Tipss").remove();
          },1500)
    ...
    var this_url=window.location.href;
        ...
        wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
            ...
            wx.updateAppMessageShareData({ 
                ...
                desc: '你好, 2022, 新年快乐！ 元旦倒计时, 一大波弹幕正在来袭！！', // 分享描述
